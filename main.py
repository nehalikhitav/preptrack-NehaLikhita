...
while student_name == "":
    student_name = input("student name cannot be empty. Enter again:  ")

registration_number = input("Enter registration number: ")

graduation_year = int(input("Enter graduation year: "))
while not(graduation_year >=2025 and graduation_year <=2027):
    graduation_year = int(input("graduation year should between 2025 to 2027. Enter again: "))

# TODO: Validate attendance between 0 and 100.
attendance = float(input("Enter attendance percentage: "))
while not(attendance>=0 and attendance<=100):
    attendance = float(input("Enter valid attendance percentage: "))
...
while project_input not in ["yes", "no"]:
    project_input= input("project input should be yes or no. Enter again: ")
...
while profile_input not in ["yes", "no"]:
    profile_input = input("profile input should be yes or no. Enter again: ")
